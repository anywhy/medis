...
func (sched *MedisScheduler) Disconnected(driver sched.SchedulerDriver) {
	log.Infof("MedisScheduler Disconnected")
}
 ...
 */
func (sched *MedisScheduler) FrameworkMessage(s sched.SchedulerDriver, eid *mesos.ExecutorID, sid *mesos.SlaveID, msg string) {
